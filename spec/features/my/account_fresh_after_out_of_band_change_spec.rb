...
# OP-19674: after an administrator changes a user's attributes out-of-band (e.g. their
# department, or the "Job title" custom field), the account page must not keep showing
# the old values. The examples below cover each way of returning to the page.
